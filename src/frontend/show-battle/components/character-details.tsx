...
import { CharacterUUID, SkillName } from '../actions/actions';
...
export type CharacterDetailsProps = {
    ...
    onCloseModal: () => void;
    onLoadSkillsCsv: (characterUUID: CharacterUUID, files: FileList | null) => void;
};
            ...
            <div className="character-details__skills">
                ...
                <input
                    ...
                    onChange={e => {
                        ...
                        onLoadSkillsCsv(character.uuid, e.target.files);
                    }}
                />
